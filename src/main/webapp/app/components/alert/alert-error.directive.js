(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('erpproductionApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-erpproductionApp-error');
                var entityKey = httpResponse.headers('X-erpproductionApp-params');
                if (errorHeader) {
