...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "manufacturingDate":"2020-01-01T00:00:00.000Z", "expirationDate":"2020-01-01T00:00:00.000Z", "description":"SAMPLE_TEXT", "price":null, "um":"SAMPLE_TEXT", "tva":null}""")).asJSON
            .check(status.is(201))
